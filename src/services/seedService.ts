  ...
  try {
    ...
    for (let i = 0; i < growNames.length; i++) {
      ...
      const growData: Grow = {
        ...
        medium: 'Coco Coir',
        startDate: {
          seconds: Math.floor(Date.now() / 1000) - 86400 * (30 + i * 10),
          nanoseconds: 0,
        } as any,
        archived: false,
    ...
    const findingTypes = [
      {
        title: 'VPD Anomaly Detected',
        rec: 'Adjust intake fan speed to increase RH. Current saturation deficit is stressing foliar structures.',
        sev: 'medium',
        cat: 'CLIMATE',
      },
      {
        title: 'Nutrient Burn Indicator',
        rec: 'Flush substrate with 5.8 pH RO water. EC levels detected at 3.2 mS/cm, exceeding maximum threshold.',
        sev: 'high',
        cat: 'NUTRITION',
      },
      {
        title: 'Substrate Moisture Critical',
        rec: 'Initiate emergency fertigation cycle. Dryback percentage has exceeded 65% limit.',
        sev: 'high',
        cat: 'IRRIGATION',
      },
      {
        title: 'Micro-pest Signature',
        rec: 'Deploy secondary IPM protocol. Visual cache analysis detected 2-pixel anomalous patterns consistent with thrip damage.',
        sev: 'medium',
        cat: 'PATHOGEN',
      },
      {
        title: 'Canopy Density Suboptimal',
        rec: 'Schedule aggressive defoliation for lower third. Light penetration compromised at Node 4.',
        sev: 'low',
        cat: 'STRUCTURE',
      },
      {
        title: 'EC Spike Detected',
        rec: 'Calibrate Dosatron. Input EC deviated by +0.4 from target vector over last 2 feed events.',
        sev: 'high',
        cat: 'SYSTEM',
      },
    ];
