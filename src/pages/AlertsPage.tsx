              ...
              {findings.map((finding) => (
                ...
                >
                  ...
                  <div className="flex-1 font-mono">
                    ...
                    <h3 className="text-sm font-bold text-zinc-200 mb-1 break-words">
                      {finding.title}
                    </h3>
                    <p className="text-[11px] text-zinc-400 leading-relaxed mb-4 break-words line-clamp-3">
        ...
        <div className="lg:col-span-4 flex flex-col gap-6 lg:border-l lg:border-brand-border lg:pl-6 max-h-full">
          <div className="border border-brand-border bg-brand-surface/20 p-6 flex flex-col gap-4 font-mono">
            ...
            <p className="text-[10px] text-zinc-500 leading-relaxed">
              The Event Pipeline analyzes chronological media arrays to auto-generate tasks. As
              visual diagnostics find anomalies (deficiencies, pests, pathogens), they flow here for
              resolution.
            </p>
